...
import 'smartswap-v3-periphery/contracts/base/PeripheryImmutableState.sol';
import 'smartswap-v3-core/contracts/libraries/SafeCast.sol';
import 'smartswap-v3-core/contracts/libraries/TickMath.sol';
import 'smartswap-v3-core/contracts/libraries/TickBitmap.sol';
...
import 'smartswap-v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
/// @title Provides on chain quotes for smartswap, V2, and MixedRoute exact input swaps
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ISmartSwapSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ISmartSwapPool;
    address public immutable factoryV2;
    /// @dev Value to bit mask with path fee to determine if V2 or smartswap route
    // max smartswap fee:           000011110100001001000000 (24 bits)
    ...
    function smartSwapSwapCallback(
        ...
        ISmartSwapPool pool = getPool(tokenIn, tokenOut, fee);
    ...
    /// @dev Fetch an exactIn quote for a smartswap Pool on chain
        ...
        )
    {
        ...
        ISmartSwapPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
    ...
    /// @dev Get the quote for an exactIn swap between an array of V2 and/or smartswap pools
